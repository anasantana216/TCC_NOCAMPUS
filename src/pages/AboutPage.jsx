    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12 bg-white rounded-2xl shadow-lg p-10 border-t-4 border-blue-900">
        ...
        <p className="text-xl text-orange-600 font-semibold bg-orange-50 py-2 px-4 rounded-full inline-block">
          🎓 Conectando toda a comunidade educacional do UNASP EC
        </p>
      </div>
      ...
      <section className="bg-white rounded-2xl shadow-xl p-10 mb-8 border-t-4 border-orange-500">
        ...
        <div className="space-y-4 text-gray-700">
          <p className="text-lg">
            O <strong><span className="text-blue-900">No</span><span className="text-yellow-500">Campus</span></strong> nasceu da necessidade de conectar melhor toda a comunidade educacional do 
            Instituto de Ensino Adventista de Engenheiro Coelho - UNASP.
          </p>
          
          <p>
            Nossa plataforma foi desenvolvida para facilitar a comunicação entre estudantes de todos os níveis de ensino (educação básica e superior), professores, 
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Fique por dentro de todas as atividades educacionais e sociais para todos os níveis</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Fortaleça os laços com toda a comunidade educacional</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Participe ativamente da vida educacional do instituto</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white rounded-lg shadow-lg p-8 mb-8">
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Instituto de Ensino Adventista de Engenheiro Coelho - UNASP</h2>
        </div>
        
        <div className="space-y-4 text-gray-700">
          <p className="text-lg">
            O <strong>Instituto de Ensino Adventista de Engenheiro Coelho - UNASP</strong> 
            é uma instituição educacional confessional adventista que oferece educação básica e ensino superior, comprometida com a excelência 
            educacional e a formação integral de estudantes de todas as idades.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-6">
            <div>
              ...
              <p className="text-gray-600">
                Educar no ambiente da fé cristã para a cidadania, promovendo a excelência educacional 
                desde a educação básica até o ensino superior, desenvolvendo o caráter semelhante ao do Criador.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Ser reconhecida como uma instituição cristã de referência em educação integral, 
                contribuindo para a transformação positiva da sociedade através de todos os níveis de ensino.
              </p>
            </div>
          </div>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-lg p-8 mb-8">
        <h2 className="text-2xl font-bold mb-6 text-center">Instituto Engenheiro Coelho</h2>
        <div className="grid md:grid-cols-3 gap-6 text-center">
          <div>
            <div className="text-3xl font-bold text-yellow-300 mb-2">60+</div>
            <div className="text-blue-100">Cursos (básica + superior)</div>
          </div>
          <div>
      ...
      <section className="text-center bg-gray-50 rounded-lg p-8">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
          O <span className="text-blue-900 font-semibold">No</span><span className="text-yellow-600 font-semibold">Campus</span> é mais que uma plataforma - é o coração digital da nossa comunidade educacional. 
          Junte-se a nós e ajude a construir um instituto ainda mais conectado e participativo para todos os níveis de ensino.
        </p>
